...
admin_kb = InlineKeyboardMarkup().add(
    InlineKeyboardButton(
        ...
        callback_data=discipline_callback.new(
            action=DisciplineActionEnum.view_sub_category.value,
            discipline_id=0,
        ),
    ),
)
    ...
    kb.row(
        InlineKeyboardButton(
            ...
            callback_data=question_edit_callback.new(
                action=QuestionActionEnum.detail.value, question_id=question_id
            ),
        ),
    )
    return kb
    ...
    kb.add(
        InlineKeyboardButton(
            ...
            callback_data=question_callback.new(
                action=QuestionActionEnum.create.value, discipline_id=discipline_id
            ),
        )
    )
    return kb
...
def edit_question_kb(question_id: int):
    ...
    kb.add(
        ...
        InlineKeyboardButton(
            ...
            callback_data=answer_callback.new(
                action=AnswerActionEnum.detail.value, question_id=question_id
            ),
        ),
        InlineKeyboardButton(
            "Редагувати фото питання",
            callback_data=question_edit_callback.new(
                action=QuestionActionEnum.edit_photo.value, question_id=question_id
            ),
        ),
        InlineKeyboardButton(
            "Редагувати текст питання",
            callback_data=question_edit_callback.new(
                action=QuestionActionEnum.edit_text.value, question_id=question_id
            ),
        ),
        InlineKeyboardButton(
            "Видалити питання",
            callback_data=question_edit_callback.new(
                action=QuestionActionEnum.delete.value, question_id=question_id
            ),
        ),
    )
    return kb
    ...
    for discipline in disciplines:
        kb.row(
            InlineKeyboardButton(
                discipline.name,
                callback_data=discipline_callback.new(
                    action=DisciplineActionEnum.detail.value,
            ...
            InlineKeyboardButton(
                "Видалити",
                callback_data=discipline_callback.new(
                    action=DisciplineActionEnum.delete.value,
                    discipline_id=discipline.id,
                ),
            ),
            InlineKeyboardButton(
                "Редагувати",
                callback_data=discipline_callback.new(
                    action=DisciplineActionEnum.edit.value, discipline_id=discipline.id
                ),
            ),
        )
    kb.add(
        InlineKeyboardButton(
            "Додати дисципліну",
            callback_data=discipline_callback.new(
                action=DisciplineActionEnum.create.value, discipline_id=0
            ),
        )
    )
    return kb
...
def edit_discipline_kb(discipline_id: int):
    ...
    kb.add(
        InlineKeyboardButton(
            "Редагувати назву",
            callback_data=discipline_edit_callback.new(
                action=DisciplineActionEnum.edit_name.value, discipline_id=discipline_id
            ),
        ),
        InlineKeyboardButton(
            "Редагувати опис",
            callback_data=discipline_edit_callback.new(
                action=DisciplineActionEnum.edit_short_description.value,
...
def get_answer_kb(answer_id: int):
    ...
    kb.row(
        InlineKeyboardButton(
            "Видалити відповідь",
            callback_data=answer_edit_callback.new(
                action=AnswerActionEnum.delete.value, answer_id=answer_id
            ),
        ),
        InlineKeyboardButton(
            "Редагувати відповідь",
            callback_data=answer_edit_callback.new(
                action=AnswerActionEnum.edit_text.value, answer_id=answer_id
            ),
        ),
    )
    return kb
